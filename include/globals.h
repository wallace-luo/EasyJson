#ifndef __EASY_JSON_GLOBALS__
#define __EASY_JSON_GLOBALS__
...
enum TokenType
{
	...
	LBR = '[', RBR = ']',
	COM = ',', COL = ':',
	NUM, STR, TRU, // number, string, true
	FAL, NUL, CMT  // false,  null, commet
};
...
protected:
	...
	// Cannot create or delete directly (only through by derived class)
	UnCopyable(){}
	~UnCopyable(){}
