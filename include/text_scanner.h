#ifndef __EASY_JSON_TEXT_SCANNER__
#define __EASY_JSON_TEXT_SCANNER__
...
/**
 * @brief	Text scanner
 * @details	Conver Json to token stream
 */
class TextScanner
{
private:
...
public:
	...
	TextScanner(const char* inp) : tokenBegin(inp), tokenEnd(inp)
	{
...
private:
	...
	// time-sapce striatage to get 1e(+/-x) value
